...
coalescing, heartbeat, expiration backstop, and ring pruning; tests drive
...
stale-ring guard, expiration backstop, heartbeat cadence + roster-suppression +
