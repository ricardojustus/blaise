...
stale-ring guard, the liveness-belief bound (heartbeats AND roster flushes stop; a co-participant event emits nothing; revival flushes the buffered roster), heartbeat cadence + roster-suppression +
