...
public final class PipelineActivityHolder {
    ...
    public func apply(_ event: PipelineEvent) -> MeetingID? {
        ...
        case .participantConfirmationNeeded, .participantAskRaised:
            break // G15: the app raises the sheet / posts the notification; run
                  // activity is cleared by the run's own runCompleted at the
                  // pending terminal.
        }
        return nil
    }
